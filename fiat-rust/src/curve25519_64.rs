...
pub fn fiat_25519_subborrowx_u51(out1: &mut u64, out2: &mut fiat_25519_u1, arg1: fiat_25519_u1, arg2: u64, arg3: u64) -> () {
  ...
  let x3: i128 = ((((x1 as i64) as u64) & 0x7ffffffffffff) as i128);
  *out1 = (x3 as u64);
...
pub fn fiat_25519_cmovznz_u64(out1: &mut u64, arg1: fiat_25519_u1, arg2: u64, arg3: u64) -> () {
  ...
  let x2: i128 = ((((((0x0 as fiat_25519_i1) - (x1 as fiat_25519_i1)) as fiat_25519_i2) as u64) & 0xffffffffffffffff) as i128);
...
pub fn fiat_25519_carry_mul(out1: &mut [u64; 5], arg1: &[u64; 5], arg2: &[u64; 5]) -> () {
  ...
  let x28: u128 = (((x26 as u64) & 0x7ffffffffffff) as u128);
  ...
  let x35: u128 = (((x33 as u64) & 0x7ffffffffffff) as u128);
  let x36: u128 = ((x34 as u128) + x31);
  let x37: u64 = ((x36 >> 51) as u64);
  let x38: u128 = (((x36 as u64) & 0x7ffffffffffff) as u128);
  let x39: u128 = ((x37 as u128) + x30);
  let x40: u64 = ((x39 >> 51) as u64);
  let x41: u128 = (((x39 as u64) & 0x7ffffffffffff) as u128);
  let x42: u128 = ((x40 as u128) + x29);
  let x43: u64 = ((x42 >> 51) as u64);
  let x44: u128 = (((x42 as u64) & 0x7ffffffffffff) as u128);
...
pub fn fiat_25519_carry_square(out1: &mut [u64; 5], arg1: &[u64; 5]) -> () {
  ...
  let x26: u128 = (((x24 as u64) & 0x7ffffffffffff) as u128);
  ...
  let x33: u128 = (((x31 as u64) & 0x7ffffffffffff) as u128);
  let x34: u128 = ((x32 as u128) + x29);
  let x35: u64 = ((x34 >> 51) as u64);
  let x36: u128 = (((x34 as u64) & 0x7ffffffffffff) as u128);
  let x37: u128 = ((x35 as u128) + x28);
  let x38: u64 = ((x37 >> 51) as u64);
  let x39: u128 = (((x37 as u64) & 0x7ffffffffffff) as u128);
  let x40: u128 = ((x38 as u128) + x27);
  let x41: u64 = ((x40 >> 51) as u64);
  let x42: u128 = (((x40 as u64) & 0x7ffffffffffff) as u128);
...
pub fn fiat_25519_to_bytes(out1: &mut [u8; 32], arg1: &[u64; 5]) -> () {
  ...
  let x25: u64 = (x14 << 3);
  let x26: u64 = (x12 >> 8);
  let x27: u64 = (((x12 as u8) & 0xff) as u64);
  let x28: u64 = (x26 >> 8);
  let x29: u64 = (((x26 as u8) & 0xff) as u64);
  let x30: u64 = (x28 >> 8);
  let x31: u64 = (((x28 as u8) & 0xff) as u64);
  let x32: u64 = (x30 >> 8);
  let x33: u64 = (((x30 as u8) & 0xff) as u64);
  let x34: u64 = (x32 >> 8);
  let x35: u64 = (((x32 as u8) & 0xff) as u64);
  let x36: u8 = ((x34 >> 8) as u8);
  let x37: u64 = (((x34 as u8) & 0xff) as u64);
  let x38: u64 = ((x36 as u64) + x25);
  let x39: u64 = (x38 >> 8);
  let x40: u64 = (((x38 as u8) & 0xff) as u64);
  let x41: u64 = (x39 >> 8);
  let x42: u64 = (((x39 as u8) & 0xff) as u64);
  let x43: u64 = (x41 >> 8);
  let x44: u64 = (((x41 as u8) & 0xff) as u64);
  let x45: u64 = (x43 >> 8);
  let x46: u64 = (((x43 as u8) & 0xff) as u64);
  let x47: u64 = (x45 >> 8);
  let x48: u64 = (((x45 as u8) & 0xff) as u64);
  let x49: u8 = ((x47 >> 8) as u8);
  let x50: u64 = (((x47 as u8) & 0xff) as u64);
  let x51: u64 = ((x49 as u64) + x24);
  let x52: u64 = (x51 >> 8);
  let x53: u64 = (((x51 as u8) & 0xff) as u64);
  let x54: u64 = (x52 >> 8);
  let x55: u64 = (((x52 as u8) & 0xff) as u64);
  let x56: u64 = (x54 >> 8);
  let x57: u64 = (((x54 as u8) & 0xff) as u64);
  let x58: u64 = (x56 >> 8);
  let x59: u64 = (((x56 as u8) & 0xff) as u64);
  let x60: u64 = (x58 >> 8);
  let x61: u64 = (((x58 as u8) & 0xff) as u64);
  let x62: u64 = (x60 >> 8);
  ...
  let x67: u64 = (x66 >> 8);
  let x68: u64 = (((x66 as u8) & 0xff) as u64);
  let x69: u64 = (x67 >> 8);
  let x70: u64 = (((x67 as u8) & 0xff) as u64);
  let x71: u64 = (x69 >> 8);
  let x72: u64 = (((x69 as u8) & 0xff) as u64);
  let x73: u64 = (x71 >> 8);
  let x74: u64 = (((x71 as u8) & 0xff) as u64);
  let x75: u64 = (x73 >> 8);
  ...
  let x80: u64 = (x79 >> 8);
  let x81: u64 = (((x79 as u8) & 0xff) as u64);
  let x82: u64 = (x80 >> 8);
...
pub fn fiat_25519_carry_scmul_121666(out1: &mut [u64; 5], arg1: &[u64; 5]) -> () {
  ...
  let x7: u128 = (((x5 as u64) & 0x7ffffffffffff) as u128);
  let x8: u128 = ((x6 as u128) + x4);
  let x9: u64 = ((x8 >> 51) as u64);
  let x10: u128 = (((x8 as u64) & 0x7ffffffffffff) as u128);
  let x11: u128 = ((x9 as u128) + x3);
  let x12: u64 = ((x11 >> 51) as u64);
  let x13: u128 = (((x11 as u64) & 0x7ffffffffffff) as u128);
  let x14: u128 = ((x12 as u128) + x2);
  let x15: u64 = ((x14 >> 51) as u64);
  let x16: u128 = (((x14 as u64) & 0x7ffffffffffff) as u128);
  let x17: u128 = ((x15 as u128) + x1);
  let x18: u64 = ((x17 >> 51) as u64);
  let x19: u128 = (((x17 as u64) & 0x7ffffffffffff) as u128);
