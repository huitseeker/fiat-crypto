...
pub fn fiat_p256_subborrowx_u64(out1: &mut u64, out2: &mut fiat_p256_u1, arg1: fiat_p256_u1, arg2: u64, arg3: u64) -> () {
  ...
  *out1 = (x3 as u64);
  *out2 = (((0x0 - (x2 as fiat_p256_u1)) as fiat_p256_i2) as fiat_p256_u1);
}
...
pub fn fiat_p256_cmovznz_u64(out1: &mut u64, arg1: fiat_p256_u1, arg2: u64, arg3: u64) -> () {
  ...
  let x2: i128 = ((((((0x0 as fiat_p256_i1) - (x1 as fiat_p256_i1)) as fiat_p256_i2) as u64) & 0xffffffffffffffff) as i128);
...
pub fn fiat_p256_to_bytes(out1: &mut [u8; 32], arg1: &[u64; 4]) -> () {
  ...
  let x4: u64 = (arg1[0]);
  let x5: u64 = (x4 >> 8);
  let x6: u64 = (((x4 as u8) & 0xff) as u64);
  let x7: u64 = (x5 >> 8);
  let x8: u64 = (((x5 as u8) & 0xff) as u64);
  let x9: u64 = (x7 >> 8);
  ...
  let x19: u8 = (x17 & 0xff);
  let x20: u64 = (x3 >> 8);
  let x21: u64 = (((x3 as u8) & 0xff) as u64);
  let x22: u64 = (x20 >> 8);
  let x23: u64 = (((x20 as u8) & 0xff) as u64);
  let x24: u64 = (x22 >> 8);
  ...
  let x34: u8 = (x32 & 0xff);
  let x35: u64 = (x2 >> 8);
  let x36: u64 = (((x2 as u8) & 0xff) as u64);
  let x37: u64 = (x35 >> 8);
  let x38: u64 = (((x35 as u8) & 0xff) as u64);
  let x39: u64 = (x37 >> 8);
  ...
  let x49: u8 = (x47 & 0xff);
  let x50: u64 = (x1 >> 8);
  let x51: u64 = (((x1 as u8) & 0xff) as u64);
  let x52: u64 = (x50 >> 8);
