...
pub fn fiat_p384_subborrowx_u64(out1: &mut u64, out2: &mut fiat_p384_u1, arg1: fiat_p384_u1, arg2: u64, arg3: u64) -> () {
  ...
  *out1 = (x3 as u64);
  *out2 = (((0x0 - (x2 as fiat_p384_u1)) as fiat_p384_i2) as fiat_p384_u1);
}
...
pub fn fiat_p384_cmovznz_u64(out1: &mut u64, arg1: fiat_p384_u1, arg2: u64, arg3: u64) -> () {
  ...
  let x2: i128 = ((((((0x0 as fiat_p384_i1) - (x1 as fiat_p384_i1)) as fiat_p384_i2) as u64) & 0xffffffffffffffff) as i128);
...
pub fn fiat_p384_to_bytes(out1: &mut [u8; 48], arg1: &[u64; 6]) -> () {
  ...
  let x6: u64 = (arg1[0]);
  let x7: u64 = (x6 >> 8);
  let x8: u64 = (((x6 as u8) & 0xff) as u64);
  let x9: u64 = (x7 >> 8);
  let x10: u64 = (((x7 as u8) & 0xff) as u64);
  let x11: u64 = (x9 >> 8);
  let x12: u64 = (((x9 as u8) & 0xff) as u64);
  let x13: u64 = (x11 >> 8);
  let x14: u64 = (((x11 as u8) & 0xff) as u64);
  let x15: u64 = (x13 >> 8);
  let x16: u64 = (((x13 as u8) & 0xff) as u64);
  let x17: u64 = (x15 >> 8);
  let x18: u64 = (((x15 as u8) & 0xff) as u64);
  let x19: u8 = ((x17 >> 8) as u8);
  let x20: u64 = (((x17 as u8) & 0xff) as u64);
  let x21: u8 = (x19 & 0xff);
  let x22: u64 = (x5 >> 8);
  let x23: u64 = (((x5 as u8) & 0xff) as u64);
  let x24: u64 = (x22 >> 8);
  let x25: u64 = (((x22 as u8) & 0xff) as u64);
  let x26: u64 = (x24 >> 8);
  let x27: u64 = (((x24 as u8) & 0xff) as u64);
  let x28: u64 = (x26 >> 8);
  ...
  let x36: u8 = (x34 & 0xff);
  let x37: u64 = (x4 >> 8);
  let x38: u64 = (((x4 as u8) & 0xff) as u64);
  let x39: u64 = (x37 >> 8);
  let x40: u64 = (((x37 as u8) & 0xff) as u64);
  let x41: u64 = (x39 >> 8);
  ...
  let x51: u8 = (x49 & 0xff);
  let x52: u64 = (x3 >> 8);
  let x53: u64 = (((x3 as u8) & 0xff) as u64);
  let x54: u64 = (x52 >> 8);
  ...
  let x66: u8 = (x64 & 0xff);
  let x67: u64 = (x2 >> 8);
  let x68: u64 = (((x2 as u8) & 0xff) as u64);
  let x69: u64 = (x67 >> 8);
  ...
  let x81: u8 = (x79 & 0xff);
  let x82: u64 = (x1 >> 8);
  let x83: u64 = (((x1 as u8) & 0xff) as u64);
  let x84: u64 = (x82 >> 8);
