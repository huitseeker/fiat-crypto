...
pub fn fiat_p448_subborrowx_u56(out1: &mut u64, out2: &mut fiat_p448_u1, arg1: fiat_p448_u1, arg2: u64, arg3: u64) -> () {
  ...
  let x3: i128 = ((((x1 as i64) as u64) & 0xffffffffffffff) as i128);
  *out1 = (x3 as u64);
  *out2 = (((0x0 - (x2 as fiat_p448_u1)) as fiat_p448_i2) as fiat_p448_u1);
}
...
pub fn fiat_p448_cmovznz_u64(out1: &mut u64, arg1: fiat_p448_u1, arg2: u64, arg3: u64) -> () {
  ...
  let x2: i128 = ((((((0x0 as fiat_p448_i1) - (x1 as fiat_p448_i1)) as fiat_p448_i2) as u64) & 0xffffffffffffffff) as i128);
...
pub fn fiat_p448_carry_mul(out1: &mut [u64; 8], arg1: &[u64; 8], arg2: &[u64; 8]) -> () {
  ...
  let x101: u128 = (((x99 as u64) & 0xffffffffffffff) as u128);
...
pub fn fiat_p448_carry_square(out1: &mut [u64; 8], arg1: &[u64; 8]) -> () {
  ...
  let x80: u128 = (((x78 as u64) & 0xffffffffffffff) as u128);
...
pub fn fiat_p448_to_bytes(out1: &mut [u8; 56], arg1: &[u64; 8]) -> () {
  ...
  let x34: u64 = (x18 >> 8);
  let x35: u64 = (((x18 as u8) & 0xff) as u64);
  let x36: u64 = (x34 >> 8);
  let x37: u64 = (((x34 as u8) & 0xff) as u64);
  let x38: u64 = (x36 >> 8);
  let x39: u64 = (((x36 as u8) & 0xff) as u64);
  let x40: u64 = (x38 >> 8);
  let x41: u64 = (((x38 as u8) & 0xff) as u64);
  let x42: u64 = (x40 >> 8);
  let x43: u64 = (((x40 as u8) & 0xff) as u64);
  let x44: u8 = ((x42 >> 8) as u8);
  let x45: u64 = (((x42 as u8) & 0xff) as u64);
  let x46: u8 = (x44 & 0xff);
  let x47: u64 = (x20 >> 8);
  let x48: u64 = (((x20 as u8) & 0xff) as u64);
  let x49: u64 = (x47 >> 8);
  let x50: u64 = (((x47 as u8) & 0xff) as u64);
  let x51: u64 = (x49 >> 8);
  let x52: u64 = (((x49 as u8) & 0xff) as u64);
  let x53: u64 = (x51 >> 8);
  let x54: u64 = (((x51 as u8) & 0xff) as u64);
  let x55: u64 = (x53 >> 8);
  let x56: u64 = (((x53 as u8) & 0xff) as u64);
  let x57: u8 = ((x55 >> 8) as u8);
  let x58: u64 = (((x55 as u8) & 0xff) as u64);
  let x59: u8 = (x57 & 0xff);
  let x60: u64 = (x22 >> 8);
  let x61: u64 = (((x22 as u8) & 0xff) as u64);
  let x62: u64 = (x60 >> 8);
  let x63: u64 = (((x60 as u8) & 0xff) as u64);
  let x64: u64 = (x62 >> 8);
  let x65: u64 = (((x62 as u8) & 0xff) as u64);
  let x66: u64 = (x64 >> 8);
  let x67: u64 = (((x64 as u8) & 0xff) as u64);
  let x68: u64 = (x66 >> 8);
  let x69: u64 = (((x66 as u8) & 0xff) as u64);
  let x70: u8 = ((x68 >> 8) as u8);
  let x71: u64 = (((x68 as u8) & 0xff) as u64);
  let x72: u8 = (x70 & 0xff);
  let x73: u64 = (x24 >> 8);
  let x74: u64 = (((x24 as u8) & 0xff) as u64);
  let x75: u64 = (x73 >> 8);
  let x76: u64 = (((x73 as u8) & 0xff) as u64);
  let x77: u64 = (x75 >> 8);
  let x78: u64 = (((x75 as u8) & 0xff) as u64);
  let x79: u64 = (x77 >> 8);
  let x80: u64 = (((x77 as u8) & 0xff) as u64);
  let x81: u64 = (x79 >> 8);
  let x82: u64 = (((x79 as u8) & 0xff) as u64);
  let x83: u8 = ((x81 >> 8) as u8);
  let x84: u64 = (((x81 as u8) & 0xff) as u64);
  let x85: u8 = (x83 & 0xff);
  let x86: u64 = (x26 >> 8);
  let x87: u64 = (((x26 as u8) & 0xff) as u64);
  let x88: u64 = (x86 >> 8);
  let x89: u64 = (((x86 as u8) & 0xff) as u64);
  let x90: u64 = (x88 >> 8);
  let x91: u64 = (((x88 as u8) & 0xff) as u64);
  let x92: u64 = (x90 >> 8);
  let x93: u64 = (((x90 as u8) & 0xff) as u64);
  let x94: u64 = (x92 >> 8);
  let x95: u64 = (((x92 as u8) & 0xff) as u64);
  let x96: u8 = ((x94 >> 8) as u8);
  let x97: u64 = (((x94 as u8) & 0xff) as u64);
  let x98: u8 = (x96 & 0xff);
  let x99: u64 = (x28 >> 8);
  let x100: u64 = (((x28 as u8) & 0xff) as u64);
  let x101: u64 = (x99 >> 8);
  let x102: u64 = (((x99 as u8) & 0xff) as u64);
  let x103: u64 = (x101 >> 8);
  let x104: u64 = (((x101 as u8) & 0xff) as u64);
  let x105: u64 = (x103 >> 8);
  let x106: u64 = (((x103 as u8) & 0xff) as u64);
  let x107: u64 = (x105 >> 8);
  let x108: u64 = (((x105 as u8) & 0xff) as u64);
  let x109: u8 = ((x107 >> 8) as u8);
  let x110: u64 = (((x107 as u8) & 0xff) as u64);
  let x111: u8 = (x109 & 0xff);
  let x112: u64 = (x30 >> 8);
  let x113: u64 = (((x30 as u8) & 0xff) as u64);
  let x114: u64 = (x112 >> 8);
  let x115: u64 = (((x112 as u8) & 0xff) as u64);
  let x116: u64 = (x114 >> 8);
  let x117: u64 = (((x114 as u8) & 0xff) as u64);
  let x118: u64 = (x116 >> 8);
  let x119: u64 = (((x116 as u8) & 0xff) as u64);
  let x120: u64 = (x118 >> 8);
  let x121: u64 = (((x118 as u8) & 0xff) as u64);
  let x122: u8 = ((x120 >> 8) as u8);
  let x123: u64 = (((x120 as u8) & 0xff) as u64);
  let x124: u8 = (x122 & 0xff);
  let x125: u64 = (x32 >> 8);
  let x126: u64 = (((x32 as u8) & 0xff) as u64);
  let x127: u64 = (x125 >> 8);
  ...
  let x133: u64 = (x131 >> 8);
  let x134: u64 = (((x131 as u8) & 0xff) as u64);
  let x135: u8 = ((x133 >> 8) as u8);
  let x136: u64 = (((x133 as u8) & 0xff) as u64);
  out1[0] = (x35 as u8);
  out1[1] = (x37 as u8);
  out1[2] = (x39 as u8);
  out1[3] = (x41 as u8);
